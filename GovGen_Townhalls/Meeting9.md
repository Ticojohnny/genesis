### **GovGen Townhall Meeting 9 Notes**
...
- Demonstration of [GovGen governance dApp](https://govgen.io/)
- Demonstration from Vladimir, of [proposal creation interface](https://proposals.posthuman.digital/)
